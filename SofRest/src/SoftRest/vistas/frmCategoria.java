...
public class frmCategoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Datos de Categoria");
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        try{
            ...
            if(pos>=0)
            {
                if(op==0)lbMensaje.setText("Nombre de categoria ya ingresado");
                else if(pos>0 && op!=0) lbMensaje.setText("Nombre de categoria ya ingresada");
    ...
    private void txtdatoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtdatoKeyReleased
        cCategoria cat=lis.buscar_varios(txtdato.getText());
    ...
    public Categoria leer()
    {
        ...
        if(form_validado()){
            ob=new Categoria();
            ob.setCodigo_categoria(Integer.parseInt(txtCodigo.getText()));
            ob.setNombre_categoria(txtNombre.getText().trim());	
