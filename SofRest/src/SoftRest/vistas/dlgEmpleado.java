 ...
 * @author henvisi
 */
public class dlgEmpleado extends java.awt.Dialog {
 //datos
    cEmpleado1 lis;
    cCargo lisTipPlato;
    cLocales lisLocal;
    ...
    private void initComponents() {
        ...
        add(txtdato, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        add(btbuscar_varios, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 750, 160));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgEmpleado dialog = new dlgEmpleado(new java.awt.Frame(), true);
